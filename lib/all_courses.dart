...
List<CourseDetails> allCourses = [
  ...
  CourseDetails(
      ...
      credit: 1.5),
  CourseDetails(
      courseTitle: "Discrete Mathematics", courseCode: "CSE-1151", credit: 3.0),
  CourseDetails(
  ...
  CourseDetails(
      courseTitle: "Electrical Circuits", courseCode: "EEE-1221", credit: 3.0),
  CourseDetails(
  ...
  CourseDetails(
      ...
      credit: 2.0),
  CourseDetails(
      courseTitle: "Digital Logic Design", courseCode: "CSE-2221", credit: 3.0),
  CourseDetails(
  ...
  CourseDetails(
      ...
      credit: 1.5),
  CourseDetails(
      courseTitle: "Software Engineering", courseCode: "CSE-3213", credit: 3.0),
  CourseDetails(
